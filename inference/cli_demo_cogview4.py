...
import torch
import argparse
from transformers import GlmForCausalLM, BitsAndBytesConfig
...
def generate_image(
    ...
    # text_encoder = GlmForCausalLM.from_pretrained(model_path + "/text_encoder", quantization_config=BitsAndBytesConfig(load_in_4bit=True), torch_dtype=dtype)
